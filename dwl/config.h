...
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xd4be98ff, 0x32302fff, 0xd195edff },
	[SchemeSel]  = { 0x32302fff, 0xf7f5a8ff, 0xf7f5a8ff },
...
static const char *menucmd[] = {"j4-dmenu-desktop", "--dmenu=mew -i -f Hack -l 10 -nb 32302f -nf d4be98 -sb f7f5a8ff -sf 32302f", NULL};
static const char *dmenucmd[] = { "mew", "-i", "-f", "Hack", "-nb", "32302f", "-nf", "d4be98", "-sb", "f7f5a8ff", "-sf", "32302f", NULL };
